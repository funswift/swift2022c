...
const exclusion_list = /東京|原宿|羽田|歌舞伎町|八王子|札幌|サッポロ|すすきの|沖縄|青森|仙台|山形|沼津|鹿児島|福島|秋田|盛岡|神田|土呂|丘珠|大宮|新潟|金沢|苫小牧|北見|帯広|室蘭|夕張|網走|ニセコ|稚内|留萌|小樽|釧路|長万部|旭川|裏垢|裏アカ|キャバ嬢|パパ活|風俗|デブ専|グラビアモデル|病み|夜勤|政権|スープラ|runkeeper|戦争|世界平和|求人|末広写真館|函館に行ってきた|言霊アロマ|地雷|自撮り/
...
export const store = createStore({
    state() {  
        return {
            ...
            search_text : null,
            fire_data: [],                    //全部のカテゴリ＋「函館」で一致するデータを格納する変数
            search_fire_data: [],         //検索結果ページに表示するデータ
            top_fire_data: [],              //トップページに表示するデータ
            eat_fire_data: [],            //食べるカテゴリページに表示するデータ    
            see_fire_data: [],           //見るカテゴリページに表示するデータ
            know_fire_data: []   //知るカテゴリページに表示するデータ
        }
    },
    mutations: {
